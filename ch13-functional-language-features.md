...
This trait uses some syntax we haven't seen before: `type Item` and `Self::Item`. This is called an _associated type_ and it's a very much like a generic type. We'll talk more about this in [chapter 19][chap19].
