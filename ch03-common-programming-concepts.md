...
Array accesses are checked at runtime. Trying to access an index which is out-of-bounds will cause your program to panic.
...
For loops in Rust are always of the format `for var in iterable {}~:
